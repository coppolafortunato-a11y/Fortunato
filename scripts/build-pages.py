...
HEAD = ('<link href="https://fonts.googleapis.com/css2?family=Archivo:wght@500;600;700'
        '&family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">\n')

CSS = """<style>
#ik-page{--navy:#1E2235;--gold:#C9A961;--paper:#f8f7f4;--rule:#e0ddd6;--muted:#6b6b73;font-family:'Inter',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#1E2235;line-height:1.6;width:100vw;max-width:100vw;margin-left:calc(50% - 50vw);overflow-x:hidden}
#ik-page *{box-sizing:border-box}
#ik-page em,#ik-page i,#ik-page cite,#ik-page blockquote{font-style:normal}
#ik-page p{margin:0}
...
#ik-page .hero h1{font-family:'Archivo',sans-serif;font-weight:600;font-size:clamp(34px,5vw,58px);line-height:1.08;letter-spacing:-.02em;color:#fff;margin:0 0 18px;max-width:22ch}
...
#ik-page .step .n{font-family:'Archivo',sans-serif;font-size:34px;color:var(--gold);line-height:1;margin-bottom:10px}
...
#ik-page h2{font-family:'Archivo',sans-serif;font-weight:600;font-size:clamp(26px,3.4vw,40px);line-height:1.15;letter-spacing:-.02em;margin:0 0 12px}
...
#ik-page .stats .n{font-family:'Archivo',sans-serif;font-size:clamp(38px,5vw,52px);color:var(--gold);line-height:1;margin-bottom:8px}
...
#ik-page .sign{font-family:'Archivo',sans-serif;font-size:22px;color:var(--navy);margin-top:18px}
...
stats = [("15+","anni di esperienza"),("1.000+","clienti che ci hanno scelto"),("1.300+","lavori realizzati"),("1","un solo partner per la tua comunicazione")]
