...
# 2) inserisci il CTA "Preventivo" dopo il blocco navigation, dentro il gruppo a destra
nav_marker = 'wp:navigation'
i = header_group.find(nav_marker)
cta_block = '\n<!-- wp:html --><a class="ik-cta-btn" href="/preventivi-ledwall/">Preventivo</a><!-- /wp:html -->\n'
if i != -1:
...
@media (max-width:780px){.ik-fab{right:16px;bottom:16px}}
...
fab = ('<div class="ik-fab">'
  ...
  '<a class="wa" href="' + wa + '" target="_blank" rel="noopener" aria-label="Scrivici su WhatsApp">' + WA_SVG + '</a>'
